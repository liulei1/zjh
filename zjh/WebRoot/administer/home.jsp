	...
	<div class="headerBar">
		<div class="logoBar">
			<div class="logo">
				<!-- start logo -->
				<h2>
					<a class="logoText fl" href="${pageContext.request.contextPath}"
						title="专家汇平台"> ZJH </a>
				</h2>
			</div>
			<p class="lineText fl">行业专家和短期项目的交流平台</p>
			<div class="loginText fr">
				<span>欢迎您!&nbsp;&nbsp;</span> <span class="user_login"
					onmouseover="userShow()" onmouseout="userHide()">${user.name}&nbsp;&gt</span>
				<ul class="user_info" id="user_info" onmouseover="userShow()"
					onmouseout="userHide()">
	...
	<div class="navBar">
		<div class="design_class fl">
			...
			<!-- <ul class="item" id="hi" onmouseover="show()" onmouseout="hide()">
				<li class="item_list"><a href="#" target="_blank">logo</a> <a
					href="#" target="_blank">包装</a> <a href="#" target="_blank">广告</a>
					<div class="item_detail">
						<dl>
							<dt>LOGO设计</dt>
							<dd>
								<a href="#" target="_blank">企业logo</a> <a href="#"
									target="_blank">地产logo</a> <a href="#" target="_blank">餐饮logo</a>
							</dd>
							<dd>
								<a href="#" target="_blank">企业logo</a> <a href="#"
									target="_blank">地产logo</a> <a href="#" target="_blank">餐饮logo</a>
				...
				<li class="item_list"><a href="#" target="_blank">app</a> <a
					href="#" target="_blank">微信</a> <a href="#" target="_blank">软件开发</a>
					<div class="item_detail second">
						<dl>
							<dt>APP开发</dt>
							<dd>
								<a href="#" target="_blank">安卓系统</a> <a href="#" target="_blank">IOS系统</a>
								<a href="#" target="_blank">餐饮app</a>
							</dd>
							<dd>
								<a href="#" target="_blank">安卓系统</a> <a href="#" target="_blank">IOS系统</a>
								<a href="#" target="_blank">餐饮app</a>
		...
		<ul class="nav">
			...
			<li role="presentation"><a
				href="${pageContext.request.contextPath}/consult/consult_unCheckList.action"
				target="myframe">ConsultCheck</a>
			</li>
			<li role="presentation"><a
				href="${pageContext.request.contextPath}/user/user_toUserInfoView"
				target="myframe">UserInfo</a>
			</li>
			...
			<li role="presentation"><a
				href="${pageContext.request.contextPath}/professor/professor_unauditlist"
				target="myframe">Audit for Professor</a>
			</li>
			<li role="presentation"><a
				href="${pageContext.request.contextPath}/company/company_unauditlist"
				target="myframe">Audit for Company</a>
			</li>
		</ul>
	</div>
	<div>
