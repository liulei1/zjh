...
<div class="headerBar">
    <div class="logoBar">
        ...
        <div class="loginText fr">
            ...
            <ul class="user_info" id="user_info" onmouseover="userShow()"onmouseout="userHide()">
                ...
                <li><a href="${pageContext.request.contextPath}/company/company_changePassword" target="myframe">修改密码</a></li>
    ...
    <div class="navBar">
        ...
        <ul class="nav">
        	<li>
		   		<a href="${pageContext.request.contextPath}/project/consult_publish.jsp" target="myframe">Publish Consult</a>
		   </li>
		   <li>
		   		<a href="${pageContext.request.contextPath}/consult/consult_queryMyConsult" target="myframe">My Consults</a>	
		   </li>
		   <li>
		   		<a href="${pageContext.request.contextPath}/project/project_queryMyProject" target="myframe">My Projects</a>	
		   </li>
		   <li>
		      <a href="${pageContext.request.contextPath}/company/company_skipBalancePage" target="myframe">Recharge</a>
		   </li>
		   <li>
		      <a href="${pageContext.request.contextPath}/company/professor_search.jsp" target="myframe">Search Professor<span class="badge pull-right" id="messageCount"></span></a>
		   </li>
        </ul>
    </div>
</div>
<div>
    <iframe name="myframe" id="iframepage" src="${pageContext.request.contextPath}/project/consult_publish.jsp"width="100%" height="500px" frameborder="0"></iframe>
</div>
</body>
</html>