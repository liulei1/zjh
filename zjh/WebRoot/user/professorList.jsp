...
<body>
<h1 align="center"><strong>Professor List</strong></h1>
	<div align="center">
			...
			<s:iterator value="professors" var="user" status="index">
				<tr>
					...
					<td align="center" style="HEIGHT: 22px">
						<s:a action="professor_editProfessorView" namespace="/professor">
					...
					<td align="center" style="HEIGHT: 22px">
						<s:a action="professor_delete" namespace="/professor" cssClass="btn btn-danger btn-xs delLink">
							<s:param name="id" value="id" />
							delete
						</s:a>
					</td>
